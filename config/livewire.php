...
return [
    ...
    */
    ...
    'component_namespaces' => [
        ...
        'pages' => resource_path('views/pages'),    // Public website (no auth)
        'admin' => resource_path('views/admin'),    // Super admin + area manager + content editor
        'manager' => resource_path('views/manager'), // Restaurant manager daily ops
        'staff' => resource_path('views/staff'),    // Server + kitchen FOH/BOH
        'portal' => resource_path('views/portal'),   // Phase 3 — loyalty member guest portal
    ],
    ...
    */
    ...
    'make_command' => [
        ...
        'emoji' => true, // ⚡ prefix on all SFC names for easy identification
        'with' => [
            'js' => false,
            'css' => false,
            'test' => true, // Always generate a Pest test alongside every component
        ],
    ],
